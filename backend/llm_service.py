...
def _fallback_office(text: str) -> str:
    rules = [
        ...
        ("教務處招生組", ["招生", "報考", "簡章", "甄試", "甄選", "分發", "考試入學", "轉學考", "招生說明會"]),
        ("教務處註冊課務組", ["學籍", "成績", "畢業證書", "休學", "復學", "轉學", "註冊", "抵免", "入學",
                       "選課", "課程", "學分", "加退選", "停修", "教室", "排課"]),
        ("學務處生活輔導組", ["獎學金", "助學金", "請假", "兵役", "操行", "急難", "學生申訴"]),
        ("兩岸事務中心", ["陸生", "港澳", "香港", "澳門", "大陸", "中國", "兩岸"]),
        ("國際事務中心", ["交換", "海外", "外籍", "外國學生", "國際學生", "留學", "國際"]),
        ("圖資處", ["圖書館", "借書", "電子資源", "資料庫", "閱覽",
                  "帳號", "密碼", "系統", "網路", "wifi", "登入", "校務系統"]),
